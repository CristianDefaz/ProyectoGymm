function init() {
  ...
  var cargartablaF = () => {
    ...
    $.post(
      "../../controllers/recibo.controller.php?op=todos",
      {},
      (listafacturas) => {
  ...
  var guardayeditarFactura = (e) => {
    ...
    if (id_recibo === undefined || id_recibo === "") {
      url = "../../controllers/recibo.controller.php?op=insertar";
    }else {
      url = "../../controllers/recibo.controller.php?op=actualizar";
    }
  ...
  var uno = async (id_recibo) => {
    await $.post('../../controllers/recibo.controller.php?op=uno', {
      id_recibo: id_recibo
    }, async (res) => {
      res = JSON.parse(res);
  ...
  var eliminar = (id_recibo) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.post('../../controllers/recibo.controller.php?op=eliminar', {
          id_recibo: id_recibo
        }, (res) => {
          res = JSON.parse(res);
          if (res === 'ok') {
