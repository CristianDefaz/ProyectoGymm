            ...
            <td>
                <table style="background-color: #f2f3f8; max-width:670px;  margin:0 auto;" width="100%" border="0"
                    ...
                    <tr>
						...
						<h2 style="color:rgba(69, 80, 86, 0.7411764705882353); font-weight:500; margin:0;font-size:32px;font-family: Rubik ,sans-serif;">Goodschool
						</h2>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
										...
										<h3 style="color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family: Rubik ,sans-serif;">'.$nombre.'
										</h3>
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <p style="font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;">&copy; <strong>Goodschool</strong></p>
                        </td>
                    </tr>
                    <tr>
                        <td style="height:80px;">&nbsp;</td>
